...
class Cifar100EmbClip(Cifar100Emb):
    def __init__(self, root_path, variant_name="cifar100_emb_clip", epochs=200):
        super().__init__(
            root_path=root_path,
...
if __name__ == "__main__":
    ...
    root_path = init_root()
    variant = Cifar100EmbClip(root_path=root_path, epochs=300)
