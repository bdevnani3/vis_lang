...
if __name__ == "__main__":
    ...
    for iter in range(flags.num_iters):
        ...
        for shot in shots[::-1]:
            ...
            if shot > 16 and flags.dataset == "flowers102":
                continue
            ...
            for epoch in range(num_epochs):
                ...
                data_dict[shot][iter]["train_loss"][epoch] = total_loss/total
            ...
            with open(f"/nethome/bdevnani3/vis_lang/efficient_finetuning/prompt_engineer/experiments/results/finetune_lambda_all_{flags.dataset}.json", "w") as outfile:
